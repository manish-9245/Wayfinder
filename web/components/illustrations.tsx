...
export function Archway({ label }: { label?: string }) {
  return (
    <Svg vb="0 0 240 200" label={label}>
      ...
      <line x1="120" y1="38" x2="120" y2="14" stroke="hsl(var(--primary))" />
      <circle cx="120" cy="10" r="3" fill="hsl(var(--primary))" stroke="none" />
      <line x1="120" y1="70" x2="120" y2="150" stroke="hsl(var(--primary))" strokeWidth="2.5" />
      <circle cx="120" cy="162" r="9" fill="hsl(var(--primary))" stroke="none" opacity=".18" />
      <path d="M114.5 162l4 4 7.5-8.5" stroke="hsl(var(--primary))" strokeWidth="2" />
...
export function Orbit({ label }: { label?: string }) {
  return (
    <Svg label={label}>
      ...
      <circle cx="48" cy="10" r="6" fill="hsl(var(--primary))" stroke="none" opacity=".9" />
      <circle cx="82" cy="66" r="6" fill="hsl(var(--info))" stroke="none" opacity=".9" />
      <circle cx="14" cy="66" r="6" fill="hsl(var(--warning))" stroke="none" opacity=".9" />
      <path d="M45 46.5l2 2 3.5-4" stroke="hsl(var(--primary))" />
    </Svg>
  );
}
...
export function Gauge({ label }: { label?: string }) {
  return (
    <Svg label={label}>
      ...
      <path d="M14 66a34 34 0 0 1 15-22" stroke="hsl(var(--destructive))" />
      <path d="M73 44a34 34 0 0 1 9 22" stroke="hsl(var(--primary))" />
      <line x1="48" y1="66" x2="66" y2="34" strokeWidth="2.5" />
      <circle cx="48" cy="66" r="5" fill="currentColor" stroke="none" opacity=".85" />
      <circle cx="66" cy="34" r="3" fill="hsl(var(--primary))" stroke="none" />
    </Svg>
  );
}
...
export function Shield({ label }: { label?: string }) {
  return (
    <Svg label={label}>
      ...
      <path d="M38 47l7 7 15-16" stroke="hsl(var(--primary))" strokeWidth="2" />
    </Svg>
  );
}
...
export function Layers({ label }: { label?: string }) {
  return (
    <Svg label={label}>
      ...
      <line x1="48" y1="52" x2="48" y2="80" stroke="hsl(var(--primary))" strokeWidth="2" />
      <circle cx="48" cy="84" r="3" fill="hsl(var(--primary))" stroke="none" />
    </Svg>
  );
}
...
export function Tongues({ label }: { label?: string }) {
  return (
    <Svg label={label}>
      ...
      <path d="M26 28h18M26 36h30M26 44h22" stroke="hsl(var(--info))" />
      <path d="M58 44c4-8 10-8 12 0s6 6 10 2" stroke="hsl(var(--primary))" />
    </Svg>
  );
}
...
export function Inbox({ label }: { label?: string }) {
  return (
    <Svg label={label}>
      ...
      <line x1="30" y1="62" x2="66" y2="62" stroke="hsl(var(--primary))" strokeWidth="2" />
...
export function EmptyBox({ label }: { label?: string }) {
  return (
    <Svg label={label}>
      ...
      <path d="M66 22v10M61 27h10" stroke="hsl(var(--primary))" strokeWidth="2" />
    </Svg>
  );
}
...
export function Lost({ label }: { label?: string }) {
  return (
    <Svg vb="0 0 160 120" label={label}>
      ...
      <circle cx="118" cy="34" r="4" fill="hsl(var(--warning))" stroke="none" />
      <path d="M104 52c6-8 14-10 22-8" stroke="hsl(var(--warning))" strokeDasharray="3 4" />
    </Svg>
  );
}
